...
This document shows the simulation results for each individual site analysed in the study with some additional notes pertaining to edits to the DTM, treatment of ^14^C-dates and other relevant information. The sites are presented in alphabetical order. Tables holding data on excavated sites and radiocarbon dates, and spatial data for site limits and site features are available in the online repoistory for the paper at https://osf.io/7F9SU

Sites with ^14^C-dates to the Stone Age, but for which no spatial data was readily available are Frebergsvik A--C [@mikkelsen1975], Nedre Holtan, Rugtvedt [@odgaard1994], Auve [@østmo2008] and Torsrød [@østmo1975]. These sites are therefore not included in the analysis.  
