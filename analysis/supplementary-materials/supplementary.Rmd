...
Hovland 5 is situated more withdrawn from the highway than the other Hovland sites (above). It only has a single ^14^C-date, but this does match the typological indicators of the assemblage [@mansrud2013]. 
...
The oldest date is not seen as relevant for the main occupation on the site, in part also due to the large error [@mansrud2018b]. The site location is similar to that of Krøgenes D1 (above), and did not require any editing.
...
Nordby 52 is a rock-shelter tat has been visited throughout prehistory [@gjerpe2008]. Clear typological date to both of the Stone Age periods defined by the ^14^C-dates treated here. The site is located by where the highway runs today (see also Nordby 1 above). Edit appears to have been successful.
...
Pjonkerød R1. Situated by a quarry today which has been fairly successfully edited. However, as the few negative values across the results are likely to result from the interpolation process and the fact that this is a quite large area, and not issues with the displacement curves or ^14^C-dates, the negative values were forced to zero for the aggregative analsysis.
