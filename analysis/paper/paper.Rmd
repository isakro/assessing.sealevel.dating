...
```{r exampledat, echo = FALSE, fig.cap = "Shoreline dating of Hegna vest 1. The dashed line marks the mean elevation of the site polygon. The exponential function decays following the $\\lambda$ from Figure 7A. The resulting shoreline date in grey is underlined with the 95\\% HDR in black.", out.width = "500px", fig.align="center", regfloat=TRUE}
