...
# This chunk tried to the load the edited DTM. Due to the file sizes involved
# this is not distributed with the repository but had to be assembled by running
# 03dtm_edit.R which compiles the original DTM stored in 400 tiles, edits this
# and stores the derived version in the derived data folder. This requires
# a local installation of GRASS GIS (see the script for more details).
