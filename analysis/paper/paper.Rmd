...
```{r shoredate, echo = FALSE, fig.cap = "The result of shoreline dating  sites by mean elevation of the site polygon, accounting for distance to closest isobase and employing the exponential decay function identified in Figure 7 for the distance between sites and shoreline. The shoreline dates in gray are plotted against the oldest radiocarbon-informed phase for each site in black. The red line indicates the 95\\% probability range for the shoreline date.", out.width = "525px", fig.align="center"}
