...
The accumulation on the 0m distance mark follow from forcing negative values to zero, from the resolution of the spatial data, and from defining intersecting sea- and site polygon as a distance of zero. 
...
```{r results2, echo = FALSE, fig.cap = "Histograms showing distance from shoreline using only dates older than 2500 BCE that correspond to the site inventory. Negative values have been set to zero.", out.width = "525px", fig.align="center"}
knitr::include_graphics(here("analysis/figures/results2.png"))
```

```{r results3, echo = FALSE, fig.cap = "Histograms showing distance from shoreline using only dates older than 4000 BCE that correspond to the site inventory. Negative values have been set to zero.", out.width = "525px", fig.align="center"}
knitr::include_graphics(here("analysis/figures/results3.png"))
```

```{r shoredate, echo = FALSE, fig.cap = "The result of shoreline dating the analysed sites allowing for a sea-level potentially 4m above to 16m below the lowest site elevation. These are plotted against the oldest radiocarbon-informed dates for each site.", out.width = "525px", fig.align="center"}
