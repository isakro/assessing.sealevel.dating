...
```{r shoredate, echo = FALSE, fig.cap = "The result of backwards shoreline dating the sites with radiocarbon dates corresponding to the artefact inventory. The sites are dated using the lowest elevation of the site polygon and by employing the exponential decay function identified in Figure 7 for the distance between sites and shoreline. The shoreline dates in gray are plotted against the oldest radiocarbon-informed phase for each site in black. The red line indicates the 95\\% probability range for the shoreline date.", out.width = "525px", fig.align="center", regfloat=TRUE}
