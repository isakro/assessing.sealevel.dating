...
```{r shoredate, echo = FALSE, fig.cap = "The result of backwards shoreline dating the sites with radiocarbon dates corresponding to the artefact inventory using the method proposed here. A) The shoreline dates are plotted in grey and underlined with the 95\\% HDR in black. These are plotted against the oldest radiocarbon-informed phase for each site in red. B) Using the method described by Parnell et al. (2008), the synchroneity of the dates is evaluated. When the range of the 95\\% HDR for age difference crosses zero the dates are considered synchronous.", out.width = "525px", fig.align="center", regfloat=TRUE}
