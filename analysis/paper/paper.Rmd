...
Where $\lambda$ is the decay ratio and $x$ is the distance to the shoreline. This can then be combined with the elevation of the site and the shoreline displacement to provide a method for shoreline dating that takes this distance into account:
