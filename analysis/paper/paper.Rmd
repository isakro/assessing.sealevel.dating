...
```{r redate, echo = FALSE, fig.cap = "Shoreline dating sites from the study area without radiocarbon dates or with radiocarbon dates that do not corresponding to the site inventories. These are comapred to the shoreline dates originally proposed by the excavation reports in black.", out.width = "525px", fig.align="center", regfloat=TRUE}
