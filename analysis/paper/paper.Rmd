...
Finding the probability for calendar dates then becomes a matter of coupling the probability of the distance between site and shoreline to that of the displacement curve:
...
We can then get rid of parameter $d$ by summarising over the possible distances between site and the shoreline. The probability distribution for the calendar date of the use of the site, given its elevation, is then given by:
