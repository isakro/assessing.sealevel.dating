...
Following the end of the Weichselian and the final retreat of the Fennoscandian Ice Sheet, the isostatic rebound has been so severe that most areas of Norway have been subject to a continuous relative sea-level regression, despite corresponding eustatic sea-level rise. In other words, the relative sea level has been dropping throughout prehistory. As this process is the result of glacial loading, the rate of uplift has been more severe towards the centre of the ice sheet. Thus, some areas on the outer coast have had a more stable sea-level, been subject to past marine transgression phases, or are still inundated today [e.g. @svendsen1987; @romundset2015]. In areas where the sea-level has been stable over longer periods of time, people have often reused the coastal site locations multiple times and over long time-spans, creating palimpsests of settlement events that are difficult to disentangle. Transgression, on the other hand, can lead to complete erosion of the sites, or bury them in marine sediments, leading for example to a hiatus in the archaeological record for certain sub-phases in the impacted areas [@bjerck2008]. Comparatively, given a continuous and still ongoing shoreline regression from as high as c. 210 m above present sea level in the inner Oslo fjord , any one location in south-eastern Norway has only been shore-bound within a relatively limited time-span, and the sites have not been impacted by any transgression phases. This makes the region especially useful for evaluating the assumption of a shore-bound settlement over time, and for identifying potential deviations from this pattern.
...
Previous evaluations of the correspondence between dates informed by radiocarbon dates and shoreline dating have typically involved a visual inspection of radiocarbon probability distributions plotted against local shoreline displacement curves based on the site elevation [@breivik2018; @solheim2020; @åstveit2018\]. This approach has a couple of limitations. Firstly, only a couple of studies have taken the variable uplift-rates into account when performing this comparison . Secondly, the question of interest in this case is effectively one of synchroneity between events, as opposed to difference \[@parnell2008]. This framing consequently flips the direction of the common null-hypothesis of no significant difference too one of equivalence. While two overlapping confidence intervals means that one cannot conclude that they are different, this does not necessarily mean that they are the same. One implication of this method is consequently that the wider the uncertainty range for either radiocarbon- or shoreline date, the higher the liklihood that the confidence intervals overlap, and the higher the likelihood that we conclude in favour of our hypothesis. The final limitation of this method is that it only takes the vertical distance between site and shoreline into account. While this is the parameter of interest for shoreline dating, the practical implications of a vertical difference in elevation will be highly dependent on the local topography.

In the case that radiocarbon dates of site features are available, this is typically evaluated by means of a visual evaluation of the overlap between shoreline displacement curves and the radiocarbon probability distributions. Another line of reasoning has been to combine these approaches with a qualitative consideration of the landscape surrounding the sites, and an evaluation of the degree to which the site location would have been sensible if the site was not shore bound [e.g. @jaksland2014]. This can for example pertain to accessibility. If the site is situated on a ledge in a steep and jagged area of the present day landscape, or if would have been located on an island. In these cases it would make intuitive sense that the location was used when the ocean reached the elevation of the site, which would then have been accessible by means of watercraft. The evaluation of the degree to which sites were shore-bound is therefore typically conducted on a site-by-site or project-by-project basis, meaning the fundamental basis for assuming shore bound site location is largely based on a mosaic of smaller scale investigations. Although it appears that the arguments for such site locations is sensible, few attempts at a comprehensive evaluation and quantification of this tendency has been done.

Based on the generally accepted premise that most Stone Age sites located lower than the marine limit were situated on or close to the contemporaneous shoreline, it is common to err on the side of a shorebound site location unless there is strong evidence to suggest otherwise. This is for example common in survey projects, which can be guided by a mental or digital reconstruction of the landscape. typically do not produce material suitable for radiocarbon dating. the most common way to evaluate whether or not a site would have been shorebound is typically through an evaluation of typological indicators in the assemblages and its correspondence with available shoreline displacement curves. If this corresponds then it is common to err on the side of a shorebound site location, even if the time-span of the dates provided by the typological indicators are too wide to decisively verify this.
