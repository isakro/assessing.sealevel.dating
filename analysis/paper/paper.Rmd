...
The shore-bound settlement is believed to follow both from a resource perspective and from one of movement and communication, which could be more efficient on waterways. The is thus also extended to the hinterland and the inland, where sites are to be located along rivers and by inland lakes. This picture is to take a dramatic turn around 2400 BCE, where the introduction of Neolithic package associated involving a change agro-pastoralism, the farm,  means that the site locations are now more withdrawn from the shoreline. That is not to say that aquatic resources were no longer exploited, but settlements and tool-production areas were no longer 
