...
```{r deglaciation, echo = FALSE, fig.cap = "Deglaciation at 1000 year intervals from 19-10 ka (data from Hughes et al. 2016). The studyarea defined later in the text is given a red outline.", out.width = "400px", fig.align="center"}
