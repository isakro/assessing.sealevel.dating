...
Where $\lambda$ is the decay ratio and $x$ is the distance to the shoreline. This can then be combined with the displacement data to provide a method for shoreline dating that takes this distance into account:
